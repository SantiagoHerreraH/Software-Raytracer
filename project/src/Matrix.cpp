...
namespace dae {
	...
	Matrix Matrix::CreateRotation(const Vector3& r)
	{
		...
		Matrix zRotation{ CreateRotationZ(r.x) };
		return Matrix{ zRotation * yRotation * xRotation};
	}
	...
	{
		Matrix scaleMatrix{};
		scaleMatrix.data[0] = { sx, 0,  0, 0 };
		scaleMatrix.data[1] = { 0, sy,  0, 0 };
		scaleMatrix.data[2] = { 0,  0, sz, 0 };
