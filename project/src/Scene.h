...
namespace dae
{
	...
	public:
		...
		Scene_W4(Scene_W3&&) noexcept = delete;
		Scene_W4& operator=(const Scene_W3&) = delete;
		Scene_W4& operator=(Scene_W3&&) noexcept = delete;
	...
	public:
		...
		Scene_W4_BunnyScene(const Scene_W3&) = delete;
		Scene_W4_BunnyScene(Scene_W3&&) noexcept = delete;
		Scene_W4_BunnyScene& operator=(const Scene_W3&) = delete;
		Scene_W4_BunnyScene& operator=(Scene_W3&&) noexcept = delete;

		void Initialize() override;

	private:
		TriangleMesh* p_Mesh{nullptr};
	};
}
